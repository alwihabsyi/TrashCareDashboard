...
import com.p2mw.trashcaredashboard.databinding.FragmentDailyImpact3Binding
...
class DailyImpact3Fragment: Fragment() {

    private var _binding: FragmentDailyImpact3Binding? = null
    private val binding get() = _binding!!
    private val viewModel by viewModels<CampaignViewModel> {
        ViewModelFactory.getTaskInstance(TaskGroup.DailyImpact3)
    }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDailyImpact3Binding.inflate(inflater)
        return binding.root
    }
