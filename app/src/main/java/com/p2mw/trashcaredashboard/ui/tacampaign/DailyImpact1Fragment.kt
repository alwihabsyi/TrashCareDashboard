...
import com.p2mw.trashcaredashboard.databinding.FragmentDailyImpact1Binding
...
class DailyImpact1Fragment : Fragment() {

    private var _binding: FragmentDailyImpact1Binding? = null
    private val binding get() = _binding!!
    private val taskAdapter by lazy { TaskAdapter() }
    private val viewModel by viewModels<CampaignViewModel> {
        ViewModelFactory.getTaskInstance(TaskGroup.DailyImpact1)
    }
    ...
    override fun onCreateView(
        ...
        _binding = FragmentDailyImpact1Binding.inflate(inflater)
        return binding.root
    }
